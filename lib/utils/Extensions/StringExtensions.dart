...
extension StringExtension on String? {
  ...
  String? validateUserName() {
    if (isEmptyOrNull) return errorThisFieldRequired;
    if (this!.contains(' ')) return "Username should not contain space";
    return null;
  }
  ...
  String? validateEmail2() => hasMatch2(this, emailPattern,"Email is invalid");

  /// Check email validation
  bool validatePassword() => this!.length >= passwordLengthGlobal;

  String? validatePassword2() {
    if (isEmptyOrNull) return errorThisFieldRequired;
    return this!.length >= passwordLengthGlobal
        ? null
  ...
  String? validatePhone2() => hasMatch2(this, phonePattern,"Phone number is invalid");
