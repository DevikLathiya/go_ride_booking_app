...
const mAppName = 'IndieCab';
var errorThisFieldRequired = 'This field is required';

const googleMapAPIKey = 'AIzaSyDKcJE3PMbrBQYLuRwB-3T9es2pM73lmLg';

// const DOMAIN_URL = 'https://meetmighty.com/mobile/mighty-taxi'; // Don't add slash at the end of the url
const DOMAIN_URL = 'https://rapido.yoursoftwaredemo.com'; // Don't add slash at the end of the url
const mBaseUrl = "$DOMAIN_URL/api/";

final client = MqttServerClient.withPort("broker.hivemq.com", "", 1883);

// const mOneSignalAppIdRider = 'c1020e9a-af10-4766-ac39-3f0f3e0252b3';
// const mOneSignalRestKeyRider = 'MjVmMGJlZTUtMGFiNC00N2FiLTgzODAtZWY4ODdlNmZkZTc3';
const mOneSignalAppIdRider = '75b9519c-56a4-47df-8e1a-b401649570b5';
const mOneSignalRestKeyRider = 'M2RiODI3ZjYtMmRjZS00NWM2LTgzNjgtMTQ1MmRkOGUyYTE2';

// const mOneSignalAppIdDriver = '9350d841-1030-40b0-8fec-4883b785c4b6';
// const mOneSignalRestKeyDriver = 'Mjk0NTY4NzEtNWUxZS00ODc3LWJkMTMtZDZiMGU1NDRlMDUx';
const mOneSignalAppIdDriver = '75b9519c-56a4-47df-8e1a-b401649570b5';
const mOneSignalRestKeyDriver = 'M2RiODI3ZjYtMmRjZS00NWM2LTgzNjgtMTQ1MmRkOGUyYTE2';
...
const mRazorDescription = 'IndieCab';
