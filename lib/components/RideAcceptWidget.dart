...
import 'package:cabuser/Screens/AlertScreen.dart';
import '../main.dart';
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              inkWellWidget(
                onTap: () {
                  //TODO launchScreen(context, ChatScreen(userData: userData), pageRouteAnimation: PageRouteAnimation.SlideBottomTop);
                },
                child: Container(
          ...
          Visibility(
            ...
            child: AppButtonWidget(
              ...
              color: primaryColor,
              onTap: () {
                //TODO launchScreen(context, ReviewScreen(driverData: widget.driverData, rideRequest: widget.rideRequest!), pageRouteAnimation: PageRouteAnimation.SlideBottomTop);
              },
            ),
          ),
