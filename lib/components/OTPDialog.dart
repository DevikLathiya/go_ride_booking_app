...
import 'package:cabuser/Screens/Login/GoRideSignUpScreen.dart';
    ...
    await FirebaseAuth.instance
      ...
      await logInApi(req, isSocialLogin: true).then((value) async {
        ...
        if (value.data == null) {
          ...
          //TODO launchScreen(context, RegisterScreen(countryCode: widget.phoneNumber!.split(" ").first, userName: widget.phoneNumber!.split(" ").last, socialLogin: true));
          launchScreen(
              context,
              GoRideSignUpScreen(
          ...
          updatePlayerId();
          Navigator.pop(context);
          //TODO launchScreen(context, RiderDashBoardScreen(), isNewTask: true);
          launchScreen(context, GoRideHomeScreen(), isNewTask: true);
        }
      }).catchError((e) {
        Navigator.pop(context);
        toast(e.toString());
