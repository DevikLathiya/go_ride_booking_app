        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text(appStore.currencyPosition == LEFT ? '${appStore.currencyCode} ${widget.service.perDistance}/${language.km}' : '${widget.service.perDistance} ${appStore.currencyCode}/${language.km}',
                  style: primaryTextStyle()),
            ],
          ),
          SizedBox(height: 16),
          Row(
            ...
            children: [
              ...
              Text(appStore.currencyPosition == LEFT ? '${appStore.currencyCode} ${widget.service.perMinuteDrive}/${language.min}' : '${widget.service.perMinuteDrive} ${appStore.currencyCode}/${language.min}',
                  style: primaryTextStyle()),
            ],
          ),
          SizedBox(height: 16),
          Row(
            ...
            children: [
              ...
              Text(appStore.currencyPosition == LEFT ? '${appStore.currencyCode} ${widget.service.perMinuteWait}/${language.min}' : '${widget.service.perMinuteWait} ${appStore.currencyCode}/${language.min}',
                  style: primaryTextStyle()),
            ],
          ),
          SizedBox(height: 16),
