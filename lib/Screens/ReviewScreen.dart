...
import 'package:cabuser/Screens/OrderDetailScreen.dart';
  ...
  Future<void> getCurrentRequest() async {
    await getCurrentRideRequest().then((value) {
      ...
      if (servicesListData != null) {
        ...
        launchScreen(context, GoRideHomeScreen(), isNewTask: true, pageRouteAnimation: PageRouteAnimation.SlideBottomTop);
      }
    }).catchError((error) {
      log(error.toString());
    });
